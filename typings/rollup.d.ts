...
export interface BundleOptions {
	...
	/** The indent string to use, for formats that require code to be indented (AMD, IIFE, UMD). Can also be false (no indent), or true (the default – auto-indent) */
...
export interface Options {
	...
	cache?: Bundle
	/** Function that returns if an ID is external or array of IDs of modules that should remain external to the bundle. The IDs should be either the name of an external dependency or a resolved ID (like an absolute path to a file) */
...
export declare function rollup(options: Options): Promise<Bundle>
